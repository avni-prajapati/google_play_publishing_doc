...
const config: Config = {
  title: 'Google Play Publishing Guide',
  tagline: 'Your All-in-One Guide',
  ...
  baseUrl: '/docs/google-play-publishing-guide/',
  ...
  themeConfig: {
    ...
    navbar: {
      title: 'PlayStore Guide',
      logo: {
        alt: 'My Site Logo',
        src: 'img/play_store_icon.svg',
      },
      items: [
        {
          type: 'docSidebar',
          ...
          items: [
            {
              ...
              to: 'https://capricious-mirror-f0d.notion.site/19e78e36475c801db7f9dc6cf2751f20?pvs=105',
            },
            {
              label: 'Check Out More Docs',
              href: '/blog/',
            },
          ],
        },
